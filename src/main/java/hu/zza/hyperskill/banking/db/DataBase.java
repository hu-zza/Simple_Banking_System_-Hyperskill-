...
public class DataBase implements AutoCloseable {
    ...
    public boolean connect() {
        return executeWithHysteresis(this::connectWithHysteresis, CONNECTED,
    ...
    @Override
    public void close() {
        executeWithHysteresis(this::closeWithHysteresis, NOT_CONNECTED,
    ...
    public DB_Reply processQuery(DB_Query dataBaseQuery) {
        ...
        try {
            return dataBaseQuery.getTransactionType()
                                .getBiFunction()
